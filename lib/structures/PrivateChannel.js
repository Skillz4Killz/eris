...
class PrivateChannel extends Channel {
    ...
    */
    getMessages(limit, before, after, around) {
        return this._client.getMessages.call(this._client, this.id, limit, before, after, around);
    }
    ...
    */
    getMessageReaction(messageID, reaction, limit, before, after) {
        return this._client.getMessageReaction.call(this._client, this.id, messageID, reaction, limit, before, after);
    }
