...
class Client extends EventEmitter {
    ...
    */
    ...
    /**
    * Join a voice channel. The voice connection ID will the guild ID
    ...
    * @returns {CategoryChannel | PrivateChannel | TextChannel | VoiceChannel | NewsChannel}
    */
    ...
    * @arg {String} channelID The ID of the channel
    * @returns {Promise<CategoryChannel | PrivateChannel | TextChannel | VoiceChannel | NewsChannel>}
    */
